...
- `subscriptionIncreaseAlerts`: sin cambios de regla (la subida de plan de Anthropic es una alerta legítima); recibe `SubscriptionService[]` de `useSubscriptionServices` y filtra `active`.
