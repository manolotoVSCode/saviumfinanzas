-- Update the admin function to include age in the results
CREATE OR REPLACE FUNCTION public.get_admin_user_stats()
 RETURNS TABLE(user_id uuid, email character varying, nombre text, apellidos text, edad integer, divisa_preferida text, created_at timestamp with time zone, transacciones_count bigint, categorias_count bigint, cuentas_count bigint, inversiones_count bigint, criptomonedas_count bigint)
 LANGUAGE plpgsql
 SECURITY DEFINER
