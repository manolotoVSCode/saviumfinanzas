-- Corregir la constraint para incluir todos los valores existentes y los nuevos
ALTER TABLE public.cuentas DROP CONSTRAINT IF EXISTS cuentas_tipo_check;

-- Crear nueva constraint que incluya todos los valores válidos
ALTER TABLE public.cuentas ADD CONSTRAINT cuentas_tipo_check 
CHECK (tipo IN ('Líquido', 'Pasivo', 'Inversiones', 'Activo', 'Hipoteca', 'Empresa Propia', 'Tarjeta de Crédito', 'Banco'));

-- Actualizar la función de datos de muestra para usar valores válidos que existen
