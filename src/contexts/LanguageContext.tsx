...
const translations = {
  es: {
    ...
    'dashboard.credit_cards': 'Tarjetas de Crédito',
    ...
    'settings.version': 'Versión 3.0.0 · Desarrollado por Manuel de la Torre · 2025',
  ...
  en: {
    ...
    'dashboard.credit_cards': 'Credit Cards',
    ...
    'settings.version': 'Version 3.0.0 · Developed by Manuel de la Torre · 2025',
