...
import { Upload, FileSpreadsheet, AlertCircle, Check, X, ArrowUpDown, ArrowUp, ArrowDown, ChevronsUpDown, Info } from 'lucide-react';
...
const BankStatementImporter = ({ accounts, categories, transactions, onImportTransactions }: BankStatementImporterProps) => {
  ...
  function parseCSVContent(content: string): ParsedRow[] {
    ...
    for (let i = 0; i < dataRows.length; i++) {
      ...
      const matchedCategoryId = findMatchingCategory(descripcion, Math.abs(montoOriginal), selectedAccountId);
